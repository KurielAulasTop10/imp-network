			...
			<div className="mx-auto px-2 py-16">
				<div className="flex flex-col items-center justify-center md:flex-row gap-12">
					<div className="relative w-full max-w-sm">
						<img
							src={cdn(
								"https://i.ibb.co/BHmqTsZY/x-gamescom-2022-logo-negativ.png",
								0,
								250,
							)}
							alt="Gamescom Logo"
					...
					<div className="flex-col hover:scale-105 transform transition-transform duration-300">
						<div className="text-center mb-12">
							...
							<p className="text-2xl font-light text-gray-200 max-w-3xl mx-auto">
								A Gamescom é uma das maiores feiras de jogos. Esta terá lugar em
								Cologne e tem diversas áreas, parceiros e jogos novos a
								apresentar. Não esquecendo ainda das variadas conferências que
								serão possíveis ver. Com a Opening Night Live começando em 19 de
								Agosto.
							</p>
							<Link
