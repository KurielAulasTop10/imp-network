  ...
  Object.keys(block).forEach((pageId) => {
    if (
      ...
      try {
        ...
        const published = properties[propertyMap['Published']][0][0] === 'Yes' || false;
        ...
        const categories = properties[propertyMap['Category']][0][0].toLowerCase().split(',') || ['Games'];
        let cover = "";
        try {
        ...
        const date = properties[propertyMap['Date']][0][1][0][1]['start_date'] || new Date();
