...
export default function RelatedPosts({ posts }: { posts: Post[] }) {
  ...
  return (
    <section className="mt-10 flex flex-col px-3 md:px-20">
      <h1 className="text-3xl font-bold drop-shadow-xl drop-shadow-gray-400">Recomendados</h1>
      ...
      {numPosts < posts.length && (
        <button
          ...
          className="mt-10 self-center rounded-3xl bg-red-600 px-8 py-2 text-white opacity-70 transition-all duration-300 hover:scale-110 hover:opacity-100"
        >
          Carregar Mais
        </button>
      )}
