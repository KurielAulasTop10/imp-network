	...
	return (
		<DayPicker
			...
			classNames={{
				...
				nav_button_previous: "left-1 hidden",
				nav_button_next: "right-1 hidden",
				...
				day_selected:
					"bg-red-900 text-zinc-50 hover:bg-red-900 hover:text-red-50 focus:bg-red-900 focus:text-red-50 dark:bg-red-50 dark:text-red-900 dark:hover:bg-red-50 dark:hover:text-red-900 dark:focus:bg-red-50 dark:focus:text-red-900",
				day_today:
